window.FORMS = {
  ...
  meg: {
    ...
    buttons: [
      {
        text: "Megger Reporting (Fillable A.C. Wire Test Sheet)",
        href: "submit.html?form=meg"
      }
    ]
  },
  ...
  megger_reporting: {
    ...
    // Place the exported PDF in the same folder as this site.
    // Recommended filename: megger_reporting.pdf
  ...
  buttons: [
    {
      ...
      href: "submit.html?form=fpv_photo"
    }
  ]
},
